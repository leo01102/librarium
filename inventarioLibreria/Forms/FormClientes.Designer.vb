...
Partial Class FormClientes
    ...
    Private Sub InitializeComponent()
        ...
        ibtnBusquedaApellido = New FontAwesome.Sharp.IconButton()
        ...
        hdtpFechaNacimiento = New ReaLTaiizor.Controls.HopeDatePicker()
        Panel3 = New Panel()
        ...
        htbcApellido = New ReaLTaiizor.Controls.HopeTextBoxCustom()
        ...
        pdtpFechaNacimiento = New ReaLTaiizor.Controls.PoisonDateTime()
        Label1 = New Label()
        Label11 = New Label()
        Label2 = New Label()
        Label3 = New Label()
        ...
        ibtnBusquedaCriterioApellido = New FontAwesome.Sharp.IconButton()
        ...
        Panel2.Controls.Add(ibtnBusquedaApellido)
        ...
        ' 
        ' ibtnBusquedaApellido
        ' 
        ibtnBusquedaApellido.Anchor = AnchorStyles.None
        ibtnBusquedaApellido.BackColor = Color.FromArgb(CByte(224), CByte(241), CByte(251))
        ibtnBusquedaApellido.FlatAppearance.BorderSize = 0
        ibtnBusquedaApellido.FlatStyle = FlatStyle.Flat
        ibtnBusquedaApellido.Font = New Font("Segoe UI", 9.75F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        ibtnBusquedaApellido.ForeColor = Color.FromArgb(CByte(5), CByte(73), CByte(171))
        ibtnBusquedaApellido.IconChar = FontAwesome.Sharp.IconChar.ContactBook
        ibtnBusquedaApellido.IconColor = Color.FromArgb(CByte(5), CByte(73), CByte(171))
        ibtnBusquedaApellido.IconFont = FontAwesome.Sharp.IconFont.Auto
        ibtnBusquedaApellido.IconSize = 25
        ibtnBusquedaApellido.ImageAlign = ContentAlignment.MiddleLeft
        ibtnBusquedaApellido.Location = New Point(48, 14)
        ibtnBusquedaApellido.Name = "ibtnBusquedaApellido"
        ibtnBusquedaApellido.Size = New Size(107, 28)
        ibtnBusquedaApellido.TabIndex = 80
        ibtnBusquedaApellido.Text = "Apellido"
        ibtnBusquedaApellido.TextAlign = ContentAlignment.MiddleRight
        ibtnBusquedaApellido.TextImageRelation = TextImageRelation.ImageBeforeText
        ibtnBusquedaApellido.UseVisualStyleBackColor = False
        ' 
        ...
        Panel6.Controls.Add(hdtpFechaNacimiento)
        Panel6.Controls.Add(Panel3)
        Panel6.Controls.Add(hdtpFechaRegistro)
        Panel6.Controls.Add(htbcApellido)
        ...
        Panel6.Controls.Add(pdtpFechaNacimiento)
        ...
        htbcCodigoPostal.Location = New Point(190, 415)
        ...
        htbcCiudad.Location = New Point(190, 542)
        ...
        htbcEmail.Location = New Point(190, 150)
        ...
        ' hdtpFechaNacimiento
        ' 
        hdtpFechaNacimiento.BackColor = Color.White
        hdtpFechaNacimiento.BorderColor = Color.FromArgb(CByte(220), CByte(223), CByte(230))
        hdtpFechaNacimiento.Date = New Date(2024, 7, 8, 0, 0, 0, 0)
        hdtpFechaNacimiento.DayNames = "LMMJVSD"
        hdtpFechaNacimiento.DaysTextColor = Color.FromArgb(CByte(96), CByte(98), CByte(102))
        hdtpFechaNacimiento.DayTextColorA = Color.FromArgb(CByte(48), CByte(49), CByte(51))
        hdtpFechaNacimiento.DayTextColorB = Color.FromArgb(CByte(144), CByte(147), CByte(153))
        hdtpFechaNacimiento.Font = New Font("Segoe UI", 9F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        hdtpFechaNacimiento.HeaderFormat = "{1} / {0}"
        hdtpFechaNacimiento.HeaderTextColor = Color.FromArgb(CByte(48), CByte(49), CByte(51))
        hdtpFechaNacimiento.HeadLineColor = Color.FromArgb(CByte(228), CByte(231), CByte(237))
        hdtpFechaNacimiento.HoverColor = Color.FromArgb(CByte(235), CByte(238), CByte(245))
        hdtpFechaNacimiento.Location = New Point(190, 312)
        hdtpFechaNacimiento.Name = "hdtpFechaNacimiento"
        hdtpFechaNacimiento.NMColor = Color.FromArgb(CByte(192), CByte(196), CByte(204))
        hdtpFechaNacimiento.NMHoverColor = Color.FromArgb(CByte(64), CByte(158), CByte(255))
        hdtpFechaNacimiento.NYColor = Color.FromArgb(CByte(192), CByte(196), CByte(204))
        hdtpFechaNacimiento.NYHoverColor = Color.FromArgb(CByte(64), CByte(158), CByte(255))
        hdtpFechaNacimiento.PMColor = Color.FromArgb(CByte(192), CByte(196), CByte(204))
        hdtpFechaNacimiento.PMHoverColor = Color.FromArgb(CByte(64), CByte(158), CByte(255))
        hdtpFechaNacimiento.PYColor = Color.FromArgb(CByte(192), CByte(196), CByte(204))
        hdtpFechaNacimiento.PYHoverColor = Color.FromArgb(CByte(64), CByte(158), CByte(255))
        hdtpFechaNacimiento.SelectedBackColor = Color.FromArgb(CByte(64), CByte(158), CByte(255))
        hdtpFechaNacimiento.SelectedTextColor = Color.White
        hdtpFechaNacimiento.Size = New Size(250, 270)
        hdtpFechaNacimiento.TabIndex = 65
        hdtpFechaNacimiento.Text = "dpFecha"
        hdtpFechaNacimiento.ValueTextColor = Color.FromArgb(CByte(43), CByte(133), CByte(228))
        ' 
        ' Panel3
        ' 
        ...
        hdtpFechaRegistro.Location = New Point(190, 376)
        ...
        ' htbcApellido
        ' 
        htbcApellido.BackColor = Color.FromArgb(CByte(232), CByte(237), CByte(242))
        htbcApellido.BaseColor = Color.White
        htbcApellido.BorderColorA = Color.FromArgb(CByte(220), CByte(223), CByte(230))
        htbcApellido.BorderColorB = Color.FromArgb(CByte(220), CByte(223), CByte(230))
        htbcApellido.Font = New Font("Segoe UI", 12F)
        htbcApellido.ForeColor = Color.FromArgb(CByte(48), CByte(49), CByte(51))
        htbcApellido.Hint = ""
        htbcApellido.HoverBorderColor = Color.FromArgb(CByte(64), CByte(158), CByte(255))
        htbcApellido.Location = New Point(190, 85)
        htbcApellido.MaxLength = 32767
        htbcApellido.Multiline = False
        htbcApellido.Name = "htbcApellido"
        htbcApellido.PasswordChar = ChrW(0)
        htbcApellido.ScrollBars = ScrollBars.None
        htbcApellido.SelectedText = ""
        htbcApellido.SelectionLength = 0
        htbcApellido.SelectionStart = 0
        htbcApellido.Size = New Size(250, 38)
        htbcApellido.TabIndex = 75
        htbcApellido.TabStop = False
        htbcApellido.UseSystemPasswordChar = False
        ' 
        ' htbcNombre
        ' 
        ...
        htbcProvincia.Location = New Point(190, 479)
        ...
        htbcDireccion.Location = New Point(190, 606)
        ...
        htbcTelefono.Location = New Point(190, 213)
        ...
        pdtpFechaRegistro.Location = New Point(190, 347)
        ...
        ' pdtpFechaNacimiento
        ' 
        pdtpFechaNacimiento.CalendarMonthBackground = Color.FromArgb(CByte(232), CByte(237), CByte(242))
        pdtpFechaNacimiento.Location = New Point(190, 283)
        pdtpFechaNacimiento.MinimumSize = New Size(0, 29)
        pdtpFechaNacimiento.Name = "pdtpFechaNacimiento"
        pdtpFechaNacimiento.Size = New Size(250, 29)
        pdtpFechaNacimiento.TabIndex = 66
        ' 
        ' Label1
        ' 
        ...
        Label11.Location = New Point(49, 488)
        ...
        Label9.Location = New Point(49, 616)
        Label9.Name = "Label9"
        ...
        Label8.Location = New Point(50, 425)
        Label8.Name = "Label8"
        ...
        Label7.Location = New Point(50, 552)
        Label7.Name = "Label7"
        ...
        Label5.Location = New Point(49, 290)
        Label5.Name = "Label5"
        ...
        pnlCriterioBusquedaMenu.Controls.Add(ibtnBusquedaCriterioApellido)
        ...
        pnlCriterioBusquedaMenu.TabIndex = 40
        ' 
        ...
        ' 
        ' ibtnBusquedaCriterioApellido
        ' 
        ibtnBusquedaCriterioApellido.BackColor = Color.FromArgb(CByte(224), CByte(241), CByte(251))
        ibtnBusquedaCriterioApellido.Dock = DockStyle.Top
        ibtnBusquedaCriterioApellido.FlatAppearance.BorderSize = 0
        ibtnBusquedaCriterioApellido.FlatStyle = FlatStyle.Flat
        ibtnBusquedaCriterioApellido.Font = New Font("Segoe UI", 9.75F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        ibtnBusquedaCriterioApellido.ForeColor = Color.FromArgb(CByte(5), CByte(73), CByte(171))
        ibtnBusquedaCriterioApellido.IconChar = FontAwesome.Sharp.IconChar.ContactBook
        ibtnBusquedaCriterioApellido.IconColor = Color.FromArgb(CByte(5), CByte(73), CByte(171))
        ibtnBusquedaCriterioApellido.IconFont = FontAwesome.Sharp.IconFont.Auto
        ibtnBusquedaCriterioApellido.IconSize = 25
        ibtnBusquedaCriterioApellido.ImageAlign = ContentAlignment.MiddleLeft
        ibtnBusquedaCriterioApellido.Location = New Point(0, 28)
        ibtnBusquedaCriterioApellido.Name = "ibtnBusquedaCriterioApellido"
        ibtnBusquedaCriterioApellido.Size = New Size(107, 28)
        ibtnBusquedaCriterioApellido.TabIndex = 44
        ibtnBusquedaCriterioApellido.Text = "Apellido"
        ibtnBusquedaCriterioApellido.TextAlign = ContentAlignment.MiddleRight
        ibtnBusquedaCriterioApellido.TextImageRelation = TextImageRelation.ImageBeforeText
        ibtnBusquedaCriterioApellido.UseVisualStyleBackColor = False
        ' 
    ...
    Friend WithEvents ibtnBusquedaApellido As FontAwesome.Sharp.IconButton
    ...
    Friend WithEvents hdtpFechaNacimiento As ReaLTaiizor.Controls.HopeDatePicker
    ...
    Friend WithEvents htbcApellido As ReaLTaiizor.Controls.HopeTextBoxCustom
    ...
    Friend WithEvents pdtpFechaNacimiento As ReaLTaiizor.Controls.PoisonDateTime
    ...
    Friend WithEvents ibtnBusquedaCriterioApellido As FontAwesome.Sharp.IconButton
