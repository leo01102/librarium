...
namespace ReaLTaiizor.Controls
{
    ...
    public class HopeRichTextBoxCustom : Control
    {
        private readonly BaseTextBox _baseTextBox = new()
        {
            BorderStyle = BorderStyle.None,
            ForeColor = HopeColors.MainText,
            BackColor = Color.FromArgb(232, 237, 242) // este será reemplazado por CustomBackColor
        };
        ...
        // nuevas propiedades para colores personalizados
        public Color CustomBackColor
        {
            get => _baseTextBox.BackColor;
            set
            {
        ...
        public Color CustomFillPathColor { get; set; } = Color.FromArgb(232, 237, 242); // color predeterminado
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            g.FillPath(new SolidBrush(CustomFillPathColor), bg); // usa CustomFillPathColor en lugar de Color.FromArgb(232, 237, 242)
            g.DrawPath(new Pen(_baseTextBox.Focused ? HoverBorderColor : BorderColor, 0.5f), bg);
        ...
        public HopeRichTextBoxCustom()
        {
            ...
            CustomBackColor = Color.FromArgb(232, 237, 242); // establece el color inicial del fondo
        }
