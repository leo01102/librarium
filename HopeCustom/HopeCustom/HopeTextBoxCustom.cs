...
namespace ReaLTaiizor.Controls
{
    ...
    public class HopeTextBoxCustom : Control
    {
        ...
        private Color _HoverBorderColor = HopeColors.PrimaryColor; // color predeterminado para el hover
        ...
        private Color _BaseColor = Color.Red; // red para que el usuario vea las esquinas y las cambie
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            _baseTextBox.Height = Math.Max(Height - 16, 0);
            ...
            // borde
            Color borderColor = _baseTextBox.Focused ? _BorderColorA : _BorderColorB;
            if (ClientRectangle.Contains(PointToClient(MousePosition)) && Enabled)
            {
                borderColor = _HoverBorderColor; // HoverBorderColor si el mouse está sobre el control
            }
            g.FillPath(new SolidBrush(BackColor), bg);
            g.DrawPath(new Pen(borderColor, 1.0f), bg);
        }

        public HopeTextBoxCustom()
        {
